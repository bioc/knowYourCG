...
vignette: >
  ...
  %\VignetteIndexEntry{"1. Introduction to KnowYourCG"}
...
standard Infinium array naming nomenclature. If analyzing **sequencing data**,
the preferred format is a YAME-compressed binary vector of 0 and 1 to indicate
